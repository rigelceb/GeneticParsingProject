public class RunMeFirst {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Then, run \"javac SearchExtension.java\"");
        System.out.println("And finally, run \"java SearchExtension.java\" and enter your filepath and chromosomal genotype into the program when prompted.");
        System.out.println();
        ...
        System.out.println("");
        System.out.println("When you are ready to begin, compile and run SearchExtension.java to search for a specific genetic marker, or compile and run TraverserExtension.java to traverse all DNA.");
    }
}